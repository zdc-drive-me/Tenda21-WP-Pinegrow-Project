...
if ( ! function_exists( 'tenda21_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'tenda21-tailwind', get_template_directory_uri() . '/tailwind_theme/tailwind.css', [], '1.0.132', 'all');

    wp_deregister_style( 'tenda21-style' );
    wp_enqueue_style( 'tenda21-style', get_bloginfo('stylesheet_url'), [], '1.0.132', 'all');
