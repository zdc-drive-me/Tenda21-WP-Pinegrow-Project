...
<header class="relative z-30 bg-white px-5 md:px-8 lg:px-10">
    <div class="mx-auto max-w-[1600px]">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/menu_line_devider.webp" alt="" aria-hidden="true" class="block w-full object-fill" style="height: 12px;">
    </div>
</header>
<!-- =========================================================
...
<footer class="
    ...
    ">
    <div class="mx-auto max-w-[1600px]">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/footer devider.webp" alt="" aria-hidden="true" class="block w-full object-fill" style="height: 9px;">
        <div class="
                mx-auto
                grid
                max-w-[760px]
