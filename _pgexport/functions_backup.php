...
if ( ! function_exists( 'tenda21_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'tenda21-style', 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500&family=Work+Sans:wght@300;400;500&display=swap', [], '1.0.14', 'all');

    wp_deregister_style( 'tenda21-tailwind' );
    wp_enqueue_style( 'tenda21-tailwind', get_template_directory_uri() . '/tailwind_theme/tailwind.css', [], '1.0.14', 'all');

    wp_deregister_style( 'tenda21-style-1' );
    wp_enqueue_style( 'tenda21-style-1', get_bloginfo('stylesheet_url'), [], '1.0.14', 'all');
...
function tenda21_blocks_init() {
    ...
    require_once 'blocks/event-card/event-card_register.php';
    require_once 'blocks/events-schedule/events-schedule_register.php';
    require_once 'blocks/experience-hero/experience-hero_register.php';
    require_once 'blocks/upcoming-events/upcoming-events_register.php';
    require_once 'blocks/experience-cta/experience-cta_register.php';
    require_once 'blocks/facilitator-hero-single/facilitator-hero-single_register.php';
