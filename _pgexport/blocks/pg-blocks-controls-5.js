...
function pgMediaImageControl(prop, setAttributes, props, image_size, inline_svg, title, help, resolveMediaUrl) {
    ...
    function getPreviewUrl() {
        ...
        return resolveMediaUrl ? resolveMediaUrl(previewUrl) : previewUrl;
    }
...
window.pgGetFeature5 = getFeature;
