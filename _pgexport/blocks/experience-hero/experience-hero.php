<section <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array('class' => "relative pt-32 pb-16 px-6 bg-bone-200", ) ); else echo 'data-wp-block-props="true"'; ?>>
    <div class="max-w-6xl mx-auto w-full">
        <a href="experiences.html" class="inline-block font-sans uppercase text-[0.65rem] tracking-[0.15em] font-medium text-forest-700 hover:text-forest-800 mb-8 transition-colors"> <span><?php echo PG_Blocks_v7::getAttribute( $args, 'back_link_label' ) ?></span> </a>
        <div class="grid md:grid-cols-2 gap-12 items-start">
            <div class="space-y-6">
                ...
                <div class="flex items-start gap-10 pt-2 border-t border-mist-400">
                    <div class="pt-6">
                        <span class="font-sans uppercase text-[0.6rem] tracking-[0.12em] font-medium text-charcoal-600 block mb-1"><?php echo PG_Blocks_v7::getAttribute( $args, 'duration_label' ) ?></span>
