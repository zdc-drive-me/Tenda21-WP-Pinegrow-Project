<section <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array('class' => "pt-28 pb-0 bg-bone-200", ) ); else echo 'data-wp-block-props="true"'; ?>>
    <div class="max-w-6xl mx-auto px-6">
        <!-- Back link -->
        <a href="events.html" class="inline-flex items-center gap-2 text-xs font-sans uppercase tracking-[0.2em] text-forest-700 hover:text-forest-800 transition-colors mb-8 block"> <span><?php echo PG_Blocks_v7::getAttribute( $args, 'back_link_label' ) ?></span> </a>
            ...
            <div class="space-y-7">
                <div class="space-y-4">
                    <div class="space-y-0.5">
                        <p class="font-sans uppercase text-[0.65rem] tracking-[0.25em] text-charcoal-500"><?php echo PG_Blocks_v7::getAttribute( $args, 'experience_label' ) ?></p>
                ...
                <div class="flex flex-wrap gap-8 pt-5 border-t border-mist-400">
                    <div class="space-y-1">
                        <span class="font-sans uppercase text-[0.6rem] tracking-[0.2em] font-medium text-charcoal-400 block"><?php echo PG_Blocks_v7::getAttribute( $args, 'type_label' ) ?></span>
                        <span class="font-sans text-sm text-charcoal-700"><?php _e( 'On-site', 'tenda21' ); ?></span>
                    </div>
                    <div class="space-y-1">
                        <span class="font-sans uppercase text-[0.6rem] tracking-[0.2em] font-medium text-charcoal-400 block"><?php echo PG_Blocks_v7::getAttribute( $args, 'location_label' ) ?></span>
                        <span class="font-sans text-sm text-charcoal-700"><?php _e( 'Serra da Estrela · Portugal', 'tenda21' ); ?></span>
                    </div>
                    <div class="space-y-1">
                        <span class="font-sans uppercase text-[0.6rem] tracking-[0.2em] font-medium text-charcoal-400 block"><?php echo PG_Blocks_v7::getAttribute( $args, 'facilitated_by_label' ) ?></span>
            ...
            <div class="space-y-4">
                ...
                <div class="border border-mist-400 bg-bone-100/70 px-4 py-3 flex items-center justify-between gap-2">
                    <div class="flex items-baseline gap-1.5">
                        <span class="font-sans uppercase text-[0.55rem] tracking-[0.2em] text-charcoal-400 shrink-0"><?php echo PG_Blocks_v7::getAttribute( $args, 'starts_label' ) ?></span>
                    ...
                    <div class="flex items-baseline gap-1.5">
                        <span class="font-sans uppercase text-[0.55rem] tracking-[0.2em] text-charcoal-400 shrink-0"><?php echo PG_Blocks_v7::getAttribute( $args, 'ends_label' ) ?></span>
                ...
                <div class="flex flex-col gap-5 bg-charcoal-900 px-5 py-5 text-bone-50">
                    <div class="flex items-end justify-between">
                        <div class="space-y-1">
                            <span class="font-sans uppercase text-[0.55rem] tracking-[0.25em] font-medium text-bone-200/60 block"><?php echo PG_Blocks_v7::getAttribute( $args, 'investment_label' ) ?></span>
                    ...
                    <p class="font-sans text-xs leading-relaxed text-bone-200/55"><?php echo PG_Blocks_v7::getAttribute( $args, 'booking_note' ) ?></p>
