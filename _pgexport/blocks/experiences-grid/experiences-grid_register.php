<?php
        ...
        PG_Blocks_v4::register_block_type( array(
            'name' => 'tenda21/experiences-grid',
            'title' => __( 'Experiences Grid', 'tenda21' ),
            'description' => __( 'Archive section wrapper for the Experience CPT. Owns the grid layout and loop. Loop item: experience-card.', 'tenda21' ),
