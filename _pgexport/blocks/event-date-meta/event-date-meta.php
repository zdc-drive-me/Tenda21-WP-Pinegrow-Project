<div <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array('class' => "flex flex-col gap-5 rounded-sm border border-mist-300 bg-bone-50/80 p-6", ) ); else echo 'data-wp-block-props="true"'; ?>>
    <div class="space-y-2">
        <span class="font-sans uppercase text-[0.6rem] tracking-[0.3em] font-medium text-charcoal-500"><?php echo PG_Blocks_v7::getAttribute( $args, 'starts_label' ) ?></span>
    ...
    <div class="space-y-2">
        <span class="font-sans uppercase text-[0.6rem] tracking-[0.3em] font-medium text-charcoal-500"><?php echo PG_Blocks_v7::getAttribute( $args, 'ends_label' ) ?></span>
    ...
    <p class="font-sans text-[0.6rem] uppercase tracking-[0.3em] text-charcoal-500"><?php echo PG_Blocks_v7::getAttribute( $args, 'timezone_label' ) ?></p>
</div>