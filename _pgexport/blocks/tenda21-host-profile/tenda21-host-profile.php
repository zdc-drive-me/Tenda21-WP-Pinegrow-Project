        ...
        <figure class="md:col-span-5 lg:col-span-5">
            ...
            <div class="aspect-[4/5] bg-mist-200 overflow-hidden relative">
                ...
                <?php if ( PG_Blocks_v7::getImageSVG( $args, 'portrait_image', false) ) : ?>
                    <?php echo PG_Blocks_v7::mergeInlineSVGAttributes( PG_Blocks_v7::getImageSVG( $args, 'portrait_image' ), array( 'class' => 'absolute inset-0 h-full w-full object-cover object-center' ) ) ?>
                <?php endif; ?>
            ...
            <figcaption class="mt-4 flex items-center justify-between">
                <span class="font-sans text-xs uppercase tracking-[0.14em] text-charcoal-600"><?php echo PG_Blocks_v7::getAttribute( $args, 'figure_label' ) ?></span>
            </figcaption>
        </figure>
        <!-- Bio content -->
        <div class="md:col-span-7 lg:col-span-6 md:pt-2">
            <div class="max-w-2xl space-y-6">
                <p class="font-sans font-light text-lg leading-[1.9] text-charcoal-800"><?php echo PG_Blocks_v7::getAttribute( $args, 'bio_p1' ) ?></p>
                <p class="font-sans font-light text-lg leading-[1.9] text-charcoal-800"><?php echo PG_Blocks_v7::getAttribute( $args, 'bio_p2' ) ?></p>
                <p class="font-sans font-light text-lg leading-[1.9] text-charcoal-800"><?php echo PG_Blocks_v7::getAttribute( $args, 'bio_p3' ) ?></p>
                <p class="font-sans font-light text-lg leading-[1.9] text-charcoal-800"><?php echo PG_Blocks_v7::getAttribute( $args, 'bio_p4' ) ?></p>
            </div>
            <!-- Soft pull-quote card -->
            <div class="mt-10 bg-bone-100/60 p-6">
                <p class="font-serif text-[clamp(1.25rem,2.4vw,1.75rem)] leading-snug text-charcoal-900"><?php echo PG_Blocks_v7::getAttribute( $args, 'pull_quote' ) ?></p>
            </div>
        </div>
    </div>
</section>