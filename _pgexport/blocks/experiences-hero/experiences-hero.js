...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'tenda21/experiences-hero', {
        apiVersion: 2,
        title: 'Experiences Hero',
        description: 'Intro/title section for the Experiences archive page. Contains page title and intro paragraph.',
        icon: 'block-default',
        ...
        example: { attributes: { title: `Experiences`, intro: `Each immersion is designed to guide you back to what matters most. Choose the path that calls to you—or let us help you find it.` } },
        edit: function ( props ) {
